        ...
        <div class="col-sm-2 bg-secondary  text-white pt-3">
            ...
            <div class=" nav navbar">
                <ul class="navigation-list list-unstyled">
                    ...
                    <li class="nav-item"><a href="" class="nav-link text-white"><i class="fas fa-gauge"></i> Water bills</a></li>
                    <li class="nav-item"><a href="view-invoices" class="nav-link text-white"><i class="fas fa-users"></i> View Invoices</a></li>
                    <li class="nav-item"><a href="" class="nav-link text-white"><i class="fas fa-file-invoice-dollar"></i> Generate Invoices</a></li>
                    <hr>
                    <li class="nav-item"><a href="" class="nav-link text-white"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Tenant</a></li>
                ...
                <div class="row g-3">
                      <div class="col-12 col-md-4">
                        <div class="card text-white bg-primary mb-4">
                            <div class="card-header d-flex align-items-center justify-content-center">
                                <h4 class="mb-0"><i class="fas fa-water me-2"></i> Water Bills</h4>
                            </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card text-white bg-success mb-4">
                            <div class="card-header d-flex align-items-center justify-content-center">
                                <h4 class="mb-0"><i class="fas fa-home me-2"></i> Houses</h4>
                            </div>
                            <div class="card-body text-white">
                                <p class=" text-center font-monospace">10</p>
                            </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card text-white bg-danger mb-4">
                            <div class="card-header d-flex align-items-center justify-content-center">
                                <h4 class="mb-0"><i class="fas fa-users me-2"></i> Tenants</h4>
                            </div>
                            <div class="card-body text-white">
                                <p class=" text-center font-monospace">10</p>
                            </div>
